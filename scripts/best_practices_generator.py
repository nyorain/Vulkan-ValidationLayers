...
class BestPracticesOutputGenerator(OutputGenerator):
    ...
    def endFile(self):
        ...
        if (self.emit):
            ...
            ext_deprecation_data = 'const layers::unordered_map<std::string, DeprecationData>  deprecated_extensions = {\n'
            ...
            ext_specialuse_data = 'const layers::unordered_map<std::string, std::string> special_use_extensions = {\n'
            for ext in sorted(self.extension_info):
