...
extern const layers::unordered_map<std::string, function_data> name_to_funcptr_map;
...
#define BUILD_DISPATCH_VECTOR(name) \\
    ...
    def endFile(self):
        ...
        if self.chassis_source:
            ...
            write('const layers::unordered_map<std::string, function_data> name_to_funcptr_map = {', file=self.outFile)
