...
static const layers::unordered_map<std::string, VkValidationFeatureDisableEXT> VkValFeatureDisableLookup = {
...
static const layers::unordered_map<std::string, VkValidationFeatureEnableEXT> VkValFeatureEnableLookup = {
...
static const layers::unordered_map<std::string, VkValidationFeatureEnable> VkValFeatureEnableLookup2 = {
    {"VK_VALIDATION_FEATURE_ENABLE_SYNCHRONIZATION_VALIDATION", VK_VALIDATION_FEATURE_ENABLE_SYNCHRONIZATION_VALIDATION},
};

static const layers::unordered_map<std::string, ValidationCheckDisables> ValidationDisableLookup = {
...
static const layers::unordered_map<std::string, ValidationCheckEnables> ValidationEnableLookup = {
