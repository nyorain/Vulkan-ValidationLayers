...
const layers::unordered_map<std::string, VkFlags> debug_actions_option_definitions = {
...
const layers::unordered_map<std::string, VkFlags> report_flags_option_definitions = {
...
const layers::unordered_map<std::string, VkFlags> log_msg_type_option_definitions = {{std::string("warn"), kWarningBit},
...
VK_LAYER_EXPORT VkFlags GetLayerOptionFlags(std::string option, layers::unordered_map<std::string, VkFlags> const &enum_data,
