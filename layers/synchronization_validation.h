...
class SyncEventsContext {
  public:
    using Map = layers::unordered_map<const EVENT_STATE *, SyncEventStateShared>;
...
class SyncValidator : public ValidationStateTracker, public SyncStageAccess {
  public:
    ...
    layers::unordered_map<VkCommandBuffer, CommandBufferAccessContextShared> cb_access_state;
