...
const layers::unordered_map<SyncStageAccessFlags, SyncStageAccessIndex> syncStageAccessIndexByStageAccessBit  = {
...
const std::array<SyncStageAccessInfoType, 80> syncStageAccessInfoByStageAccessIndex { {
    {
